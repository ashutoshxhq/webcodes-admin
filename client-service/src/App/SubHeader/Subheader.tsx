                        ...
                        <span><i className="flaticon2-search-1"></i></span>
                            ...
                            <div className="kt-subheader__toolbar">
                                <div className="kt-subheader__wrapper">
                                    <a href="#" className="btn kt-subheader__btn-secondary">Today</a>

                                    <a href="#" className="btn kt-subheader__btn-secondary">Month</a>

                                    <a href="#" className="btn kt-subheader__btn-secondary">Year</a>

                                    <a href="#" className="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-toggle="kt-tooltip" title="Select dashboard daterange" data-placement="left">
                                    ...
                                    <div className="dropdown dropdown-inline" data-toggle-="kt-tooltip" title="Quick actions" data-placement="left">
                                        ...
                                        <span className="kt-badge kt-badge--brand kt-badge--rounded">5</span>
                                                ...
                                                <li className="kt-nav__foot">
                                                    ...
                                                    <a className="btn btn-clean btn-bold btn-sm kt-hidden" href="#" data-toggle="kt-tooltip" data-placement="right" title="Click to learn more...">Learn more</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
